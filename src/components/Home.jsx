  ...
  const primaryFeatures = [
    {
      name: 'Store',
      description:
        '5GB for free. Expandable on demand. Store all your photos, audio, and videos.',
      href: '#',
      icon: BoltIcon,
    },
    {
        ...
        <main>
              ...
              <div className="mx-auto mt-16 flex max-w-2xl sm:mt-24 lg:ml-10 lg:mr-0 lg:mt-0 lg:max-w-none lg:flex-none xl:ml-32">
                <div className="max-w-3xl flex-none sm:max-w-5xl lg:max-w-none">
                  <img
                    ...
                    width={32}
                    height={42}
                    className="w-[29rem] rounded-md bg-white/5 shadow-2xl ring-1 ring-white/10"
                  />
                </div>
              </div>
            </div>
          ...
          <div className="mx-auto mt-32 max-w-7xl px-6 sm:mt-56 lg:px-8">
            <div className="mx-auto max-w-2xl text-center">
              <h2 className="text-base font-semibold leading-7 text-indigo-400">share faster</h2>
              <p className="mt-2 text-3xl font-bold tracking-tight text-white sm:text-4xl">
              All of your files are Handled more efficiently
              </p>
            </div>
          ...
          <div className="mt-32 sm:mt-56">
            <div className="mx-auto max-w-7xl px-6 lg:px-8">
              <div className="mx-auto max-w-2xl sm:text-center">
                ...
                <p className="mt-6 text-lg leading-8 text-gray-300">
                  with up to 5GB of free space, back up all your files
                </p>
              </div>
            </div>
